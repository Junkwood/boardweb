...
function addReplyFnc(e){
	...
	addHtp.onload = function(e){
		...
		if(result.retCode=='OK'){
			alert('등록성공');
			const endlistHtp = new XMLHttpRequest();
			endlistHtp.open('get','getTotal.do?bno='+bno);
			endlistHtp.send();
			endlistHtp.onload = function(e){
				let aresult=JSON.parse(endlistHtp.responseText);
				let totalCnts=aresult.totalCount;
